...
from torchaudio import transforms as aud_transforms  # maintained for completeness
...
class SmokeAudio(Dataset):
    """Synthetic in-memory audio stub matching Whisper feature geometry."""
...
def build_dataloader(cfg: DatasetCfg, split: str = "train") -> DataLoader:
    ...
    # 1. Attempt LiveBench datasets first
